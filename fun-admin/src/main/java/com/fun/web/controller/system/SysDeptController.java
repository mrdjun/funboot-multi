...
import com.fun.system.domain.SysDept;
import com.fun.system.domain.SysRole;
import com.fun.system.service.ISysDeptService;
...
public class SysDeptController extends BaseController {
    ...
    @PostMapping("/add")
    @ResponseBody
    public R addSave(@Validated SysDept dept) {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public R editSave(@Validated SysDept dept) {
        if (UserConstants.DEPT_NAME_NOT_UNIQUE.equals(deptService.checkDeptNameUnique(dept))) {
